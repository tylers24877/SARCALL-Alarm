...
class TeamPrefixDragAdapter(adapterCustomMessages: TeamPrefixRecyclerViewAdapter, dragDirs: Int, swipeDirs: Int) :
    ItemTouchHelper.SimpleCallback(dragDirs, swipeDirs) {

    private val mAdapter: TeamPrefixRecyclerViewAdapter = adapterCustomMessages
