...
class SMSNumbersDragAdapter(adapterCustomMessages: SMSNumbersRecyclerViewAdapter, dragDirs: Int, swipeDirs: Int) :
    ItemTouchHelper.SimpleCallback(dragDirs, swipeDirs) {

    private val mAdapter: SMSNumbersRecyclerViewAdapter = adapterCustomMessages
